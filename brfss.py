...
missing_cols_df = utils.count_missing(big_df)
...
missing_rows_df = utils.count_missing(big_df, orientation=1)
...
percent_missing_df = utils.percent_missing(big_df)
...
cont_cols = ['ALCDAY5', 'N_AVEDRNK', 'CHILDREN', 'CPDEMO1B', 'N_DIABAGE', 'DRNKDRI2', 'FALLINJ3', 'MAXDRNKS',
             'SLEPTIM1', 'HEIGHT3', 'HHADULT', 'MENTHLTH', 'NUMMEN', 'NUMWOMEN', 'N_NUMPHON', 'PHYSHLTH',
             'POORHLTH', 'WEIGHT2', 'DOCTDIAB', 'CHKHEMO3', 'FEETCHK', 'DRVISITS', 'MARIJAN1', 'NUMBURN3',
             'LCSFIRST', 'LCSLAST', 'LCSNUMCG', 'CNCRAGE', 'HTIN4', 'HTM4', 'WTKG3', 'N_BMI', '_CHLDCNT']
